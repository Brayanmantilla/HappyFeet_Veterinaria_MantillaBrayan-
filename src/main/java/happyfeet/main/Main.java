...
public class Main {
    ...
    private final DuenoView duenoView = new DuenoView(scanner);   // ✅ Pasar el scanner
    private final MascotaView mascotaView = new MascotaView(scanner); // ✅ Pasar el scanner
